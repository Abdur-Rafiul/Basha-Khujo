...
class paymentController extends Controller
{
    public function index(Request $request,$id){
        ...
        $fields = array(
            ...
            'amount' => $basha->flat_charge, //transaction amount
    ...
    public function success(Request $request){
        ...
        $booking = new Booking();
        $booking->basha_id = $request->opt_c;
        $booking->flat_charge = $request->amount_original;
        $booking->sit_charge = $request->opt_b;
        $booking->user_name = $request->cus_name;
        $booking->user_email = $request->cus_email;
        $booking->user_phone = $request->cus_phone;
