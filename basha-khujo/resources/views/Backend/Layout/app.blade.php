...
<div   class="d-flex" id="wrapper">
    ...
    <div style="background-image:url({{url('photo/in_registration.png')}})"  class="" id="sidebar-wrapper">
        <div class="sidebar-heading text-center py-4 primary-text fs-4 fw-bold text-uppercase border-bottom"><i
                class="fa-solid fa-user me-2"></i>{{ Auth::user()->name }}</div>
        <div class="list-group list-group-flush my-3">
            ...
            <a href="{{route('customer.list')}}" class="list-group-item list-group-item-action bg-transparent second-text fw-bold"><i
                    class="fas fa-chart-line me-2"></i>Customer List</a>
